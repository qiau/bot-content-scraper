...
from src.handlers.telegram_handler import _send_admin_message, init_telegram, close_telegram
    ...
    try:
        async with aiohttp.ClientSession(
            ...
            for name, accounts in (
                ...
                if (
                    post_result == "auth_error"
                    or story_result == "auth_error"
                ):
